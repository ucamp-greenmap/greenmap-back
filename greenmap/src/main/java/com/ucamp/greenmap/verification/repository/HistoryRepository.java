...
""", nativeQuery = true)
    Long countThisMonth(@Param("memberId") Long memberId);
...
""", nativeQuery = true)
    Long countLastMonth(@Param("memberId") Long memberId);
...
LIMIT 1
""", nativeQuery = true)
    CategoryCount mostActiveCategoryThisMonth(@Param("memberId") Long memberId);
